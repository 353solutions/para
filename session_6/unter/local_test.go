...
/* Fixture (setup/teardown) scopes
- function:
	setup: call a function
	teardown: defer, t.Cleanup
- Group of functions (suite)
	- setup/teardown like above
	- t.Run to run tests
- package
	TestMain
- whole test suite:
...
func setup()                       {}
func teardown()                    {}
func testA(port int, t *testing.T) {}
...
func TestSuite(t *testing.T) {
	...
	// Q: How do I pass server port to all?
	t.Context()

	// t.Run("A", testA)
	t.Run("A", func(t *testing.T) { testA(8080, t) })
	t.Run("B", testB)
}
